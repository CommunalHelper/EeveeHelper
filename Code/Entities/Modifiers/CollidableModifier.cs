...
public class CollidableModifier : Entity, IContainer
{
	...
	private Dictionary<Entity, Solid> solids = new();
	private Dictionary<Entity, Hazard> hazards = new();
	private Dictionary<Entity, Component> hazardComponents = new();
	...
	{
		if (mode == Mode.Solid && !solids.ContainsKey(entity) && entity.Collider != null && (!keepBaseCollision || entity is not Solid))
		{
