...
public class CoreZone : Entity
{
	...
	private static string[] hotTags = new[] { "hot" };
	private static string[] coldTags = new[] { "cold" };
	private static string[] noTags = new[] { "nocore" };

	public static Dictionary<string, Session.CoreModes> ZoneGroups = new();
	...
	{
		return Scene.CollideFirst<CoreZone>(point);
	}
	...
	{
		return ZoneGroups.ContainsKey(id) ? ZoneGroups[id] : Session.CoreModes.Hot;
	}
